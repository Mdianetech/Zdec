    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Client Portal */}
          <div>
            <h4 className="font-semibold text-lg text-white mb-4">Espace client</h4>
            <ul className="space-y-3">
              <li>
                <Link to="/login" className="hover:text-white hover:underline transition-colors">Se connecter</Link>
              </li>
              <li>
                <Link to="/register" className="hover:text-white hover:underline transition-colors">S'inscrire</Link>
              </li>
              <li>
                <Link to="/dashboard" className="hover:text-white hover:underline transition-colors">Suivi de projets</Link>
              </li>
              <li>
                <Link to="/dashboard/quotes" className="hover:text-white hover:underline transition-colors">Demander un devis</Link>
              </li>
              <li>
                <Link to="/dashboard/appointments" className="hover:text-white hover:underline transition-colors">Prendre rendez-vous</Link>
              </li>
            </ul>
          </div>
